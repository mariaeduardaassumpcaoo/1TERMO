...
# um valor para o local onde a função foi chamada. O valor retornado pode ser usado 
...
# Return: Envia o resultado de volta para quem chamou a função (opcinal).
def calcular_dobro(numero):
    return numero * 2
# Como usar: resultado = calcular_dobro(5)
print(calcular_dobro(9))
